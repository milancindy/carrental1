...
import top.naccl.common.pojo.DataTablesResult;
import top.naccl.entity.manager.dto.MemberDto;
...
public interface MemberService {
     ...
     * @return
     */
    TbMember getMemberById(long memberId) throws Exception;
    ...
    DataTablesResult getMemberList(int draw, int start, int length, String search,
                                   String minDate, String maxDate, String orderCol, String orderDir) throws Exception;
